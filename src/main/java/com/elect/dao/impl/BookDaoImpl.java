...
public class BookDaoImpl implements BookDao {
    ...
    public List<Book> findBookAll() throws Exception {
        ...
        while(rs.next()){
            Book book=new Book(rs.getInt(1),rs.getString(2),rs.getString(3),rs.getLong(4),rs.getString(5),rs.getString(6),rs.getString(6),rs.getInt(7),rs.getString(8),rs.getString(9),rs.getString(10),rs.getString(11));
            books.add(book);
        }
        connection.close();
        return books;
