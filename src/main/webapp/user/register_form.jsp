...
<html xmlns="http://www.w3.org/1999/xhtml">
	<head>
        ...
        <script type="text/javaScript" src="../js/regist-form.js"></script>
	</head>
	<body>
		...
		<div class="fill_message">
			<form name="ctl00" method="post" action="register_form.user" id="f" onsubmit="return checkForm()">
				<h2>
					以下均为必填项
				</h2>
				<table class="tab_login" >
					...
					<tr>
						...
						<td>
							<img class="yzm_img" id='imgVcode' src="../code.code" />
							<input name="number" type="text" id="txtVerifyCode" class="yzm_input" />
							<div class="text_left t1">
								<p class="t1">
									<span id="vcodeValidMsg">请输入图片中的验证码。</span><br/>
									
									<span id="number_info" style="color:red"></span>
									<a href="javaScript:;" onclick="document.getElementById('imgVcode').src = '../code.code?'+(new Date()).getTime()">看不清楚？换个图片</a>
								</p>
							</div>
						</td>
					</tr>
